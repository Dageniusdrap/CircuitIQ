...
import { Upload, Zap, FileUp, Sparkles, Plane, Car, Ship } from "lucide-react"
                        ...
                        >
                            <UploadDropzone
                                ...
                                onClientUploadComplete={async (res) => {
                                    // 1. Mark as processing locally with enhanced metadata
                                    const newFiles: UploadFileStatus[] = res.map(file => ({
                                        name: file.name,
                                        url: file.url,
                                        key: file.key,
